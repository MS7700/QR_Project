        ...
        public async Task<ActionResult> RegisterEmpleado(RegisterEmpleadoViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    db.Direccion.Add(model.EmpleadoVM.Direccion);
                    db.SaveChanges();
                    ...
                    db.Empleado.Add(model.EmpleadoVM.Empleado);
                    db.SaveChanges();
                    await SignInManager.SignInAsync(user, isPersistent: false, rememberBrowser: false);
            ...
            ViewBag.ID_Departamento = new SelectList(db.Departamento, "ID_Departamento", "Nombre",model.EmpleadoVM.Empleado.ID_Departamento);
            ViewBag.Id_Estado_Cliente = new SelectList(db.Estado_Cliente, "Id_Estado_Cliente", "Descripcion", model.EmpleadoVM.Empleado.Id_Estado_Cliente);
            ViewBag.Id_Sucursal = new SelectList(db.Sucursal, "ID_Sucursal", "Nombre", model.EmpleadoVM.Empleado.Id_Sucursal);
            ViewBag.Id_Tipo_Identificacion = new SelectList(db.Tipo_Identificacion, "Id_Tipo_Identificacion", "Descripcion", model.EmpleadoVM.Empleado.Id_Tipo_Identificacion);

            ViewBag.Id_Pais = new SelectList(db.Pais, "Id_Pais", "Nombre_Pais", model.EmpleadoVM.Direccion.Id_Pais);
        ...
        public async Task<ActionResult> RegisterCliente(RegisterClienteViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    db.Direccion.Add(model.ClienteVM.Direccion);
                    db.SaveChanges();
                    ...
                    db.Cliente.Add(model.ClienteVM.Cliente);
                    db.SaveChanges();
                    await SignInManager.SignInAsync(user, isPersistent: false, rememberBrowser: false);
            ...
            ViewBag.Id_Estado_Cliente = new SelectList(db.Estado_Cliente, "Id_Estado_Cliente", "Descripcion", model.ClienteVM.Cliente.Id_Estado_Cliente);
            ViewBag.Id_Tipo_Identificacion = new SelectList(db.Tipo_Identificacion, "Id_Tipo_Identificacion", "Descripcion", model.ClienteVM.Cliente.Id_Tipo_Identificacion);

            ViewBag.Id_Pais = new SelectList(db.Pais, "Id_Pais", "Nombre_Pais", model.ClienteVM.Direccion.Id_Pais);

...
namespace QR_Project_5.Controllers
{
    ...
    public class SucursalsController : Controller
    {
        ...
        {
            var sucursal = db.Sucursal.Include(s => s.Empleado1);
        ...
        public ActionResult Create([Bind(Include = "ID_Sucursal,Nombre,Id_Empleado_Representante")] Sucursal sucursal)
        {
            ...
            ViewBag.Id_Empleado_Representante = new SelectList(db.Empleado, "ID_Empleado", "Identificacion", sucursal.Id_Empleado_Representante);
            return View(sucursal);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Sucursal,Nombre,Id_Empleado_Representante")] Sucursal sucursal)
        {
            if (ModelState.IsValid)
            {
